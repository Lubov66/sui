...
impl PeerRoundTracker {
    ...
    pub(crate) fn calculate_quorum_rounds_and_propagation_delay(
        ...
        let received_quorum_rounds = self.compute_received_quorum_round();
        ...
        let accepted_quorum_rounds = self.compute_accepted_quorum_round();
        ...
        // likely accepted rounds from new blocks will provide us with the most accurate
        // propagation delay.
        ...
        debug!("Computed propagation delay: {propagation_delay}",);
    ...
    fn compute_received_quorum_round(&self) -> Vec<QuorumRound> {
        self.context
            .committee
            .authorities()
            .map(|(peer, _)| {
    ...
    fn compute_accepted_quorum_round(&self) -> Vec<QuorumRound> {
